...
Digital sound board with 18 inputs. You need to use the iPad to control it wirelessly as it doesn't have physical controls. The Router is needed to connect to the board wirelessly.
